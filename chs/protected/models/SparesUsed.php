 ...
 * @property string $date_ordered_from_manufacturer
 *
...
class SparesUsed extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('master_item_id, servicecall_id', 'numerical', 'integerOnly'=>true),
			array('unit_price, total_price', 'numerical'),
			array('part_number,date_ordered, modified, notes, date_ordered_from_manufacturer, date_posted', 'safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'date_ordered_from_manufacturer' => 'Date Ordered From Poland',
			'created' => 'Created',
			'modified' => 'Modified',
			'notes' => 'Notes'
		);
