...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo Yii::app()->request->baseUrl; ?>/css/fullcalendar/fullcalendar.css"/>
    <link rel="stylesheet" type="text/css"
          href="<?php echo Yii::app()->request->baseUrl; ?>/css/fullcalendar/fullcalendar.print.css"/>
...
<div class="container" id="page">
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td style="margin:20px; text-align:right;">
                <div id="logo">
                    <a href='<?php echo $baseUrl; ?>' style='color:#555;text-decoration:none;'>
                        <?php echo $header_name; ?><br>
                        <small>Call Handling</small></div>
                </a>
    ...
    if ($tasksCount > 0) {
        ...
        <div style="text-align:justify; margin:10px;background-color:#FAF88D">
					...
					<b><a href="<?php echo $notifyUrl; ?>">Tasks Pending: Click Here</a> :There are some notification
                        tasks pending about the Status Updates of Service Calls.</b>
...
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBCxU9WGQ-qZ0AY7cE_TP5timk7sb2cQZ4&signed_in=true&libraries=places&callback=initAutocomplete"
    async defer></script>
