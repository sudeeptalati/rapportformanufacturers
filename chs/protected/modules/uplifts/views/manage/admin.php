...
//		'request_type_id',
		...
		//array('name'=>'retailer_id', 	'value'=>'($data->retailer->company)?"$data->retailer->company":""',   'filter'=>false),
		array('name'=>'authorised_by', 'value'=>'$data->authorisedByUser->username', 'filter'=>false),
